...
export const evokeecuv3: Project = {
  id: 8,
  title: 'Advanced ECU or VCU version 3 PCB Design',
  category: 'electrical',
  image: './images/PCB design/3D_V3.3 1.png',
  images: [
    '../images/PCB design/3D_V3.3 1.png',
    '../images/PCB design/3D_V3.3 2.png',
    '../images/PCB design/3D_V3.3 3.png',
    '../images/PCB design/ECU V3.jpg',
  ],
  ...
  links: [
    {
      title: 'Documentation',
      url: '../projects/pcb-design/ecu_html_doc.html',
      icon: FileText
    },
    {
      title: 'Interactive BOM',
      url: '../projects/pcb-design/InteractiveBOM_V3.3.0_2025-5-25.html',
      icon: FileSpreadsheet
    },
    {
      title: 'Schematic',
      url: '../projects/pcb-design/ECU V3-protected.pdf',
      icon: Code
    }
  ],
}
